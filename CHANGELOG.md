...
* **youtube/theme:** change seekbar color via preference ([1185cee](https://github.com/xscd/revanced-integrations/commit/1185ceedf7fdb40759261ae8560e79604c8cb743))
* **youtube/theme:** color explore drawer background ([#203](https://github.com/xscd/revanced-integrations/issues/203)) ([cb40408](https://github.com/xscd/revanced-integrations/commit/cb404086ad7b74a4280ccfaaed49e1edafe6eaf8))
* **youtube/video-speed:** change custom video speeds inside app settings ([#393](https://github.com/xscd/revanced-integrations/issues/393)) ([b42790f](https://github.com/xscd/revanced-integrations/commit/b42790fbca0f6c854d41871834fd6266dd2ea106))
* **youtube/wide-searchbar:** rename patch ([8493f57](https://github.com/xscd/revanced-integrations/commit/8493f57879f0075c73932240b61bf0c52efda0ed))
* **youtube:** `copy-video-url` patch ([#263](https://github.com/xscd/revanced-integrations/issues/263)) ([e856d9d](https://github.com/xscd/revanced-integrations/commit/e856d9dccdf11888005e757e84a06523ad2c8dc5))
* **youtube:** `disable-zoom-haptics` patch ([#217](https://github.com/xscd/revanced-integrations/issues/217)) ([fe74f6d](https://github.com/xscd/revanced-integrations/commit/fe74f6d8a6740a4d4544344474756c8ac717748f))
* **youtube:** `hide-breaking-news-shelf` patch ([#258](https://github.com/xscd/revanced-integrations/issues/258)) ([eec90ee](https://github.com/xscd/revanced-integrations/commit/eec90ee04cdfcad08f0448c0f2e860e6eb25294f))
* **youtube:** `hide-captions-button` patch ([#175](https://github.com/xscd/revanced-integrations/issues/175)) ([867645e](https://github.com/xscd/revanced-integrations/commit/867645ea5b853c01e9f3f0a87797b0bba62460fa))
* **youtube:** `hide-floating-microphone-button` patch ([cb77e96](https://github.com/xscd/revanced-integrations/commit/cb77e96da91bb4707d8559757cd86a7583f8048b))
* **youtube:** `hide-load-more-button` patch ([#389](https://github.com/xscd/revanced-integrations/issues/389)) ([7da9d44](https://github.com/xscd/revanced-integrations/commit/7da9d440eedfc895b49aac40498f0279156ad117))
* **youtube:** `hide-mix-playlists` patch ([#177](https://github.com/xscd/revanced-integrations/issues/177)) ([0e6a92f](https://github.com/xscd/revanced-integrations/commit/0e6a92fb33fbe660c71dcf15146cde7131693619))
* **youtube:** `hide-player-buttons` patch ([d5bcef2](https://github.com/xscd/revanced-integrations/commit/d5bcef2cdbe5dfdb1ad2552e7fde339cee1a3f27))
* **youtube:** `navigation-buttons` patch ([68f42fc](https://github.com/xscd/revanced-integrations/commit/68f42fc9800210f6c4d6f8e85c0132bf0cbc06d3))
* **youtube:** `open-links-directly` patch ([#201](https://github.com/xscd/revanced-integrations/issues/201)) ([c3c1656](https://github.com/xscd/revanced-integrations/commit/c3c16563ea4e55234b8dea24732ce5e53bb562c8))
* **youtube:** `open-links-externally` patch ([4cbe833](https://github.com/xscd/revanced-integrations/commit/4cbe8338b3f4ab49139168d7a3d0c9ebebf68952))
* **youtube:** `remember-playback-rate` patch ([b5c0c84](https://github.com/xscd/revanced-integrations/commit/b5c0c843a502a7f4938053d136e826fbf7399e7b))
* **youtube:** `spoof-app-version` patch ([#282](https://github.com/xscd/revanced-integrations/issues/282)) ([fd818a3](https://github.com/xscd/revanced-integrations/commit/fd818a35f5252fc0a37e12b528e020cdfac0ab53))
* **youtube:** add `hide-filter-bar` patch ([9649c3d](https://github.com/xscd/revanced-integrations/commit/9649c3dbc8406c3639c4fff9dd179d6d29886e60))
* **youtube:** add `hide-shorts-components` patch ([5ec90db](https://github.com/xscd/revanced-integrations/commit/5ec90db28a46e8f5d79f4793c141a7411a2da05d))
* **youtube:** add options to disable toasts on connection errors ([#402](https://github.com/xscd/revanced-integrations/issues/402)) ([ae18edd](https://github.com/xscd/revanced-integrations/commit/ae18edd047d7979307bc28f28db17bae2c5cc226))
* **youtube:** bump patches compatibility to v17.43.36 ([#194](https://github.com/xscd/revanced-integrations/issues/194)) ([6da66be](https://github.com/xscd/revanced-integrations/commit/6da66be067fdfe0db376925ecf5c96aa01162a2c))
* **youtube:** import / export of revanced settings ([#388](https://github.com/xscd/revanced-integrations/issues/388)) ([c3f08d8](https://github.com/xscd/revanced-integrations/commit/c3f08d8d7e8116496611b85508fbd54bb3a71992))
* **youtube:** remove `custom-video-buffer` patch ([#1718](https://github.com/xscd/revanced-integrations/issues/1718)) ([d5919a8](https://github.com/xscd/revanced-integrations/commit/d5919a8a2cff09bb884ea01ca6b01d8d2d0b8980))
* **youtube:** remove non working patch `hide-my-mix` ([436a84e](https://github.com/xscd/revanced-integrations/commit/436a84ee0785e5b0bed1b9a4a02b5be86eff4a4a))
* **youtube:** remove patch `open-links-directly` ([dce882b](https://github.com/xscd/revanced-integrations/commit/dce882b12809c074ae796b3551ddd82806bd084d))
* **youtube:** rename `video-speed` to `playback-speed` ([#438](https://github.com/xscd/revanced-integrations/issues/438)) ([630776f](https://github.com/xscd/revanced-integrations/commit/630776fd3514435dd83ef1c765a4f5b007e8e2f2))
* **youtube:** show toasts along exceptions ([#293](https://github.com/xscd/revanced-integrations/issues/293)) ([dbf1f3f](https://github.com/xscd/revanced-integrations/commit/dbf1f3f0ce0500752e5d6c4ce49d7d2b27cc6dc4))
* **youtube:** support version `18.19.35` ([b47a781](https://github.com/xscd/revanced-integrations/commit/b47a781ba710e6fb66e144ef95cdd51af358e4de))
* **youtube:** support version `18.23.35` ([#433](https://github.com/xscd/revanced-integrations/issues/433)) ([dec7348](https://github.com/xscd/revanced-integrations/commit/dec73482038b3cc8b2031fd876643f89d937d142))
* **youtube:** user selectable default video speed and quality ([#354](https://github.com/xscd/revanced-integrations/issues/354)) ([14223f4](https://github.com/xscd/revanced-integrations/commit/14223f40b5ca48f35bbecfd849dff20dfd309d92))


### Performance Improvements

* **general-ads:** hook pathBuilder ([c7756e1](https://github.com/xscd/revanced-integrations/commit/c7756e1299bdc2e241525ad89561ea67bc372e3a))
* **general-ads:** initialize blocks once ([5add970](https://github.com/xscd/revanced-integrations/commit/5add970f610c567f4b49f2a2ec8574ab393b5b5c))
* remove obsolete SDK checks ([#174](https://github.com/xscd/revanced-integrations/issues/174)) ([1755662](https://github.com/xscd/revanced-integrations/commit/1755662a7aa87bebf5ab0d2bd3e51df0aafd4a92))
* return earlier when possible ([#427](https://github.com/xscd/revanced-integrations/issues/427)) ([12f3f97](https://github.com/xscd/revanced-integrations/commit/12f3f975525863e593216ecf36ca817d162474e1))
* **youtube/general-ads-patch:** reduce amount of components to filter ([#204](https://github.com/xscd/revanced-integrations/issues/204)) ([502feaf](https://github.com/xscd/revanced-integrations/commit/502feaf4448bf0442f852fbb8fdcb639239664db))
* **youtube/general-ads-patch:** reduce amount of ignored components ([#237](https://github.com/xscd/revanced-integrations/issues/237)) ([bf368e8](https://github.com/xscd/revanced-integrations/commit/bf368e8dd49a91ba1d7a1df66344f77d8b788072))
* **youtube/general-ads-patch:** reduce list of ignored component names ([#261](https://github.com/xscd/revanced-integrations/issues/261)) ([8d233a2](https://github.com/xscd/revanced-integrations/commit/8d233a2f82f49b93adb90e2b11c9fa46836dd9b0))
